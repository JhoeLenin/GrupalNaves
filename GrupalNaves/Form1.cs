...
namespace GrupalNaves
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // Descomenta estas líneas y observa la ventana "Salida" de Visual Studio
            // para verificar si el formulario está recibiendo las pulsaciones de teclas.
            ...
            // IMPORTANTE: El juego solo se inicializará DESPUÉS de que el menú haya devuelto una selección.
            // La llamada a InicializarJuego y el inicio de gestorMovimiento se harán en OnNaveSeleccionada.
        }
        ...
        private void InicializarJuego()
        {
            try
            {
                naveJugador = new Naves(avionSeleccionado)
                {
                    ...
                    Escala = 0.2f // Escala de la nave en el juego
                };
            }
